...
USB_DMA_NONINIT_DATA_ALIGN(USB_DATA_ALIGN_SIZE) static uint8_t s_KeyBuffer[USB_HID_KEYBOARD_REPORT_LENGTH];
...
const usbState_t usbStates[] = {
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_CTRL, 0x00, KEY_ESCAPE, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_P, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_A, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_I, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_N, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_T, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_ENTER, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{200, MOUSE, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{150, MOUSE, {0x01, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{150, MOUSE, {0x01, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{150, MOUSE, {0x01, 0x01, (uint8_t)(-2), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{150, MOUSE, {0x01, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{150, MOUSE, {0x01, 0x01, 0x00, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00}},
		{150, MOUSE, {0x01, 0x01, (uint8_t)(-2), 0x00, 0x02, 0x00, 0x00, 0x00, 0x00}},
		{300, MOUSE, {0x01, 0x00, 0x00, (uint8_t)(-2), 0x02, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_CTRL, 0x00, KEY_ESCAPE, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_B, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_L, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_O, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_C, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_ENTER, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_GUI, 0x00, KEY_LEFTARROW, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_CTRL, 0x00, KEY_ESCAPE, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_B, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_L, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_O, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_C, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_ENTER, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_GUI, 0x00, KEY_RIGHTARROW, 0x00, 0x00, 0x00, 0x00, 0x00}},
//QUINCE	{100, KEYBOARD, {0x00, 0x00, 0x00, 0X00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{200, MOUSE, {0x01, 0x00, (uint8_t)(-4), 0X00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{200, MOUSE, {0x01, 0x00, 0x00, 0X00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{1, MOUSE, {0x01, 0x01, 0x00, 0X00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, MOUSE, {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_H, KEY_O, KEY_L, KEY_A, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_SPACEBAR, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, KEY_M, KEY_U, KEY_N, KEY_D, KEY_O, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_CTRL, 0x00, KEY_E, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_CTRL, 0x00, KEY_C, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{200, MOUSE, {0x01, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{1, MOUSE, {0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{1, MOUSE, {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, MODIFERKEYS_LEFT_CTRL, 0x00, KEY_V, 0x00, 0x00, 0x00, 0x00, 0x00}},
		{100, KEYBOARD, {0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}
...
static usb_status_t USB_DeviceHidMouseAction(void)
{
    static int16_t delay = 1;
    static uint8_t stateId = 0;
    uint8_t i;

	if(delay == 0){
		if(N_STATES-1 == stateId)
		...
		if(MOUSE == usbStates[stateId].device){
			for(i = 0; i<5; i++)
				g_UsbDeviceHidMouse.buffer[i] = usbStates[stateId].buffer[i];
		}
	}

	if(delay < usbStates[stateId].delay){
		delay++;
	}
	else{
		delay = 0;
...
static void USB_DeviceApplicationInit(void)
{
    ...
    g_UsbDeviceHidMouse.buffer_key       = s_KeyBuffer;
